                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="/archived-products" style="cursor: pointer">Archived Products</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fa fa-fw fa-cogs"></i>Settings</a>
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" style="cursor: pointer">Payment Gateways</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" style="cursor: pointer">SMS Configuration</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" style="cursor: pointer">Firebase Setup</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
