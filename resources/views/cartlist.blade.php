    ...
    <div class="row my-3 shadow-lg rounded justify-content-center align-items-center" id="cart-container">   
            ...
            <div class="col-md-4 mb-3">
                <form action="{{route('remove.cart')}}" method="POST">
                    ...
                    <button type="button" @if(Auth::check()) onclick="remove_cart(this)" @else onclick="window.location.href='/login'"  @endif class=" my-3 btn btn-danger">Remove product</button><br>
                </form>
    </div>
</div>
           @endforeach
